...
public class UserDAO implements UserDAOI{
	...
	public boolean identifyUser(String uname,String pass){
		...
		try{
			...
			String sql="select * from USERDETAILS where uname='"+uname+"' and pass='"+pass+"'";
...
public User getUserEnqDetails(String user){
	...
	try{
			con=DBConnectionFactory.getConnection();
			Statement st=con.createStatement();
			String sql="select firstName,lastName,emailId,mobile from USERDETAILS where uname='"+user+"'";
